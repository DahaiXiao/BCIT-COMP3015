    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden md:ml-6 md:flex md:items-center md:space-x-4">
                    <a href="courses.php" class="text-white px-3 py-2 rounded-md text-sm font-medium">Course</a>
                </div>

                <div class="hidden md:ml-6 md:flex md:items-center md:space-x-4">
                    <a href="newcourse.php" class="text-white px-3 py-2 rounded-md text-sm font-medium">Add New Course</a>
                </div>

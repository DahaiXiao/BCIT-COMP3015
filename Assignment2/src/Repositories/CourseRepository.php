...
class CourseRepository extends Repository
{
	 ...
	 * courses = table name
	 */
	public function saveCourse(string $coursename, $completed, int $user_id): bool
	{
	 ...
	 * courses = table name
	 */
	public function deleteCourse(string $coursename): bool
	{
		$sqlStatement = $this->mysqlConnection->prepare("DELETE FROM courses WHERE coursename=$coursename");
		$sqlStatement->bind_param('ssi', $coursename, $completed, $user_id);
		return $sqlStatement->execute();
	}
}
